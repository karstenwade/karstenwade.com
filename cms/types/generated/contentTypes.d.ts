...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manage webinars, workshops, meetups, and conferences';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    ...
    current_attendees: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    > &
      Schema.Attribute.DefaultTo<'meetup'>;
    faq: Schema.Attribute.JSON;
    gallery: Schema.Attribute.Media<'images' | 'videos', true>;
    is_free: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    is_virtual: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    max_attendees: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    organizer: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
    ...
    virtual_url: Schema.Attribute.String;
  };
}
